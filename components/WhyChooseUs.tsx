...
export default function WhyChooseUs() {
  return (
    <section className="w-full border-y border-ink/10 bg-surface py-16 sm:py-24">
      <div className="mx-auto max-w-content px-6 md:px-10 lg:px-0">
        ...
        <div className="mt-16 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4 lg:gap-[129px]">
