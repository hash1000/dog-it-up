  ...
  return (
    <section className="relative w-full overflow-visible">
      <div className="relative mx-auto aspect-[1440/428] w-full max-w-[1600px]">
        {/* Red band: bottom 314/428 = 73.36% of section height, full-bleed width */}
        <div
        ...
        <div className="absolute inset-x-[6.94%] top-0 h-full overflow-hidden">
          <Image
            src="/signature-flavors/signature-flavors-hero.png"
          ...
          <div className="absolute left-[0.81%] top-[49.07%] flex flex-col gap-[6.78%]">
            <h2 className="text-h1 font-bold text-surface">Signature Flavors.</h2>
            <h2 className="text-h1 font-normal text-[#fffaf9]">Endless Cravings.</h2>
          </div>
        </div>
      </div>
    </section>
